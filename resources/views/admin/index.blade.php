...
<div class="row">
    <div class="col-xs-12">
        ...
        ">
            ...
            <div class="box-body">
                @if ($version->isLatestPanel())
                    You are running Enzonic Cloud <code>{{ config('app.fork-version') }}</code> based on Pterodactyl Panel version <code>{{ config('app.version') }}</code>. Your panel is up-to-date!
                @else
