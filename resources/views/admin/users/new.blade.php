                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="server_limit" value="{{ old('server_limit') }}" class="form-control form-autocomplete-stop">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="cpu_quota" value="{{ old('cpu_quota') }}" class="form-control form-autocomplete-stop">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="ram_quota" value="{{ old('ram_quota') }}" class="form-control form-autocomplete-stop">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="disk_quota" value="{{ old('disk_quota') }}" class="form-control form-autocomplete-stop">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="port_quota" value="{{ old('port_quota') }}" class="form-control form-autocomplete-stop">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="backup_quota" value="{{ old('backup_quota') }}" class="form-control form-autocomplete-stop">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="database_quota" value="{{ old('database_quota') }}" class="form-control form-autocomplete-stop">
                                </div>
                            </div>
                        </div>
                    </div>
