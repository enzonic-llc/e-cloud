                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="pDeployName" name="deploy_name" value="{{ $egg->deploy_name }}" class="form-control" />
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="checkbox checkbox-primary no-margin-bottom">
                                    <input id="pIsDeployable" name="is_deployable" type="checkbox" value="1" @if($egg->is_deployable) checked @endif />
                            ...
                            <div class="form-group">
                                <div class="checkbox checkbox-primary no-margin-bottom">
                                    <input id="pIsMinecraft" name="is_minecraft" type="checkbox" value="1" @if($egg->is_minecraft) checked @endif />
